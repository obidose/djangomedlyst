"""
Django settings for medlyst_project project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-5q@0axzm^(^ps^02j+d1q&nk^cx2fm2jrgq55!!p3^bw5wpzz(')
...
ROOT_URLCONF = 'medlyst_project.urls'
...
WSGI_APPLICATION = 'medlyst_project.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.2/ref/settings/#databases

# Use PostgreSQL if DATABASE_URL is provided, otherwise use SQLite for development
